...
describe("Recipes", function() {
  ...
  it("should add a recipe on POST", function() {
    const newRecipe = { name: "milkshake", ingredients: ["chocolate ice cream", "milk"]};
    return chai
      .request(app)
      .post("/recipes")
      .send(newRecipe)
  ...
  it("should update recipe on PUT", function() {
    ...
    // we can make a second, PUT call to the app.
    const updateData = {
      name: "best foo for you",
      ingredients: ["foo salt", "foo pepper"]
    };
  ...
  // test strategy:
  //  1. GET recipe so we can get ID of one
  //  to delete.
  //  2. DELETE an item and ensure we get back a status 204
